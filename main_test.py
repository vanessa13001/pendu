...
def main():
    ...
    try:
        ...
        game_mode = 0 # 0 = easy mode, 1 = hard mode
        username_input = ''
        player_input = '_'
        page = 0
        ...
        while True:
            ...
            match game_menu:
                case "main_menu":
                    ...
                    menu_button = display_main_menu(screen, hovered["start_button"], hovered["score_button"], hovered["quit_button"])
                ...
                case "scores_menu":        
                    ...
                    if pages == 0:
                        ...
                        left_arrow_rect, right_arrow_rect = pygame_display.scores_menu(screen, page, pages,hovered["left"], hovered["right"])
                        reset_button_rect = pygame_display.scores_menu_buttons(screen,1,25,hovered["reset_button"])

                    back_button_rect = pygame_display.scores_menu_buttons(screen,2,460,hovered["back_button"])
